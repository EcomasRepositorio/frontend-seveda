...
const Graduate = () => {
  ...
  return (
    <section id="/cursos">
      <div className="relative pt-20 pb-20 bg-gradient-to-t from-white to-customPurple800">
      ...
      <div className="p-4 relative z-10 bg-gradient-to-b from-white via-customPurple800/30 to-white ">
        <div className="ml-20 mr-20 bg-gradient-to-br rounded-md shadow-md text-black ">
          {sections.map((section) => (
            <div key={section.id} className="border-b">
              <button
                className="w-full text-left p-4 bg-transparent focus:outline-none bg-blue-500"
